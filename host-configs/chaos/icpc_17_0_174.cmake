...
set(COMMON_FLAGS "-gnu-prefix=/usr/apps/gnu/4.9.3/bin/ -Wl,-rpath,/usr/apps/gnu/4.9.3/lib64 -std=c++11")
#set(COMMON_FLAGS "-cxxlib=/usr/apps/gnu/4.9.3/ -std=c++11")
...
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} ${COMMON_FLAGS} -O0 -g -std=c++11" CACHE STRING "")

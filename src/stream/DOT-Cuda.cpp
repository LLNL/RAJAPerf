...
void DOT::runCudaVariant(VariantID vid, size_t tid)
{
  if ( !gpu_block_size::invoke_or(
           gpu_block_size::RunCudaBlockSize<DOT>(*this, vid), gpu_block_sizes_type()) ) {
    std::cout << "\n  DOT : Unsupported Cuda block_size " << getActualGPUBlockSize()

...
void POLYBENCH_3MM::runSeqVariant(VariantID vid)
{
  ...
  auto poly_3mm_lam2 = [=] (Index_type i, Index_type j, Index_type k, Real_type &dot) {
                              POLYBENCH_3MM_BODY2_RAJA;
                            };

  auto poly_3mm_lam3 = [=] (Index_type i, Index_type j, Real_type &dot) {
  ...
  auto poly_3mm_lam5 = [=] (Index_type j, Index_type l, Index_type m, Real_type &dot) {
                              POLYBENCH_3MM_BODY5_RAJA;
                            };

  auto poly_3mm_lam6 = [=] (Index_type j, Index_type l, Real_type &dot) {
  ...
  auto poly_3mm_lam8 = [=] (Index_type i, Index_type l, Index_type j, Real_type &dot) {

...
void INIT3::runCudaVariant(VariantID vid, size_t tid)
{
  if ( !gpu_block_size::invoke_or(
           gpu_block_size::RunCudaBlockSize<INIT3>(*this, vid), gpu_block_sizes_type()) ) {
    std::cout << "\n  INIT3 : Unsupported Cuda block_size " << getActualGPUBlockSize()

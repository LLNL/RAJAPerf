...
using hip_items_per_thread_type = integer::make_gpu_items_per_thread_list_type<
    detail::hip::grid_scan_default_items_per_thread<Idx_type, block_size, RAJA_PERFSUITE_TUNING_HIP_ARCH>::value,
    integer::LessEqual<detail::hip::grid_scan_max_items_per_thread<Idx_type, block_size>::value>>;
                          ...
                          Index_type iend)
{
  ...
  detail::hip::GridScan<Idx_type, block_size, items_per_thread>::grid_scan(

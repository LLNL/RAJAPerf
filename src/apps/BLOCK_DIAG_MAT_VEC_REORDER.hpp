...
#ifndef RAJAPerf_Apps_BLOCK_DIAG_MAT_VEC_REORDER_HPP
#define RAJAPerf_Apps_BLOCK_DIAG_MAT_VEC_REORDER_HPP

#include "RAJA/RAJA.hpp"
#include "common/KernelBase.hpp"

#define BLOCK_DIAG_MAT_VEC_REORDER_DATA_INIT                                    \
...
#define BLOCK_DIAG_MAT_VEC_REORDER_DATA_SETUP                   \
  Real_ptr Me = m_Me;                                   \
  Real_ptr X = m_X;                                     \
  Real_ptr Y = m_Y;

#define BLOCK_DIAG_MAT_VEC_REORDER_BODY                         \
    Real_type dot = 0;                                  \
...
class BLOCK_DIAG_MAT_VEC_REORDER : public KernelBase {
public:
  BLOCK_DIAG_MAT_VEC_REORDER(const RunParams &params);

  ~BLOCK_DIAG_MAT_VEC_REORDER();

...
#if 1
                             RAJA::nested::TypedFor<3, RAJA::seq_exec, ID>,
                             RAJA::nested::TypedFor<2, RAJA::seq_exec, IZ>,
                             RAJA::nested::TypedFor<1, RAJA::seq_exec, IG>,
                             RAJA::nested::TypedFor<0, RAJA::seq_exec, IM> >{},
